...
<div class="under-header min-w-9xl">
  ...
  <a href="#" class="min-w-56 text-center border-x-1">Услуги</a>
  <a href="#" class="min-w-56 text-center border-x-1">Поддержка</a>
  <a href="#" class="min-w-56 text-center border-x-1">Логин</a>
</div>